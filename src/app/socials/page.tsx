        ...
        <section className="py-20 h-[90%] w-full  flex flex-col items-center gap-14 md:justify-center">
            ...
            <section className=" flex flex-col justify-center md:flex-row max-w-[150px] min-w-[150px] w-[50%] gap-10 md:gap-16">
                <section className="">
                    ...
                    <h1 className=" font-glb text-accent mt-5  text-2xl text-center ">
                        <a href="https://github.com/bitspaceorg">@bitspaceorg</a>
                    </h1>
                </section>
                <section className="">
                ...
                <section className="">
                    <a href={user ? `https://discord.gg/RSCMzzGf8H` : `${CLIENT_URL}`}>
                ...
                <section className="">
                    ...
                    <h1 className=" font-glb text-accent mt-5  text-2xl text-center ">
                        <a href="https://twitter.com/bitspaceorg">@bitspaceorg</a>
                    </h1>
                </section>
                ...
                <section className="mb-32 md:mb-0">
                    ...
                    <h1 className="font-glb text-accent mt-5  text-2xl text-center">
                        <a href="https://www.instagram.com/bitspaceorg">@bitspaceorg</a>
                    </h1>
                </section>
            </section>
        </section>
